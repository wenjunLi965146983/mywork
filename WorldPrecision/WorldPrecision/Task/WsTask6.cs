...
namespace WorldPrecision.Task
{
    ...
    public class WsTask6 : TaskUnit
    {
        ...
        public WsTask6(string name, TaskGroup taskGroup) : base(name, taskGroup)
        {
        ...
        public override void Process()
        {
            ...
            switch (taskInfo.iTaskStep)
            {
                ...
                case 12:
                    int iSta = 0;
                    Int32.TryParse(mainPLC.plcData.dicScanItems[PLC1.工位6清洗状态].strValue, out iSta);
                    ...
                    if (100 == iSta || 101 == iSta)
                    {
                        ...
                        {
                            //通知PLC PC已经收到清洗开始信号
                            mainPLC.WriteData(PLC1.工位6清洗状态, 101);
                        }
                        //电芯清洗中开始采集数据
                        float fTemp1 = 0;
                        float fTemp2 = 0;
                        float.TryParse(remotePLC.plcData.dicScanItems[PLC2.工位6喷淋压力].strValue, out fTemp1);
                        float.TryParse(remotePLC.plcData.dicScanItems[PLC2.工位6干燥压力].strValue, out fTemp2);
                    ...
                    mainPLC.WriteData(PLC1.工位6清洗状态, 0);
                ...
                case 21:
                    ...
                    strInsideCode = "";
                    strOutsideCode = "";
                    mainPLC.omronFinsAPI.ReadString(mainPLC.plcData.dicScanItems[PLC1.工位6二维码1], 32, ref strInsideCode);
                    mainPLC.omronFinsAPI.ReadString(mainPLC.plcData.dicScanItems[PLC1.工位6二维码2], 32, ref strOutsideCode);
                    ...
                    {
                        mainPLC.WriteData(PLC1.工位6清洗状态, 301);
                        strErr = "从PLC获取二维码失败！";
                    ...
                    {
                        //MES屏蔽
                        mainPLC.WriteData(PLC1.工位6清洗状态, 200);
                ...
                case 31:
                    ...
                    {
                        //MES NG
                        mainPLC.WriteData(PLC1.工位6清洗状态, 302);
                ...
                case 501: //致命异常，需重新开始
                    ...
                    mainPLC.plcData.dicScanItems[PLC1.工位6清洗状态].strValue = "0";
