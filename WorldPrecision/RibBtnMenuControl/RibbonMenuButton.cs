...
namespace RibbonStyle
{
    public class RibbonMenuButton : Button
    {
        ...
        public void DrawImage(Graphics gr)
        {
            if (this.Image != null)
            {
                offsety = _imageoffsetY; offsetx = _imageoffsetX;
            ...
            if (this.Text != "")
            {
                ...
                switch (_imagelocation)
                {
                    case e_imagelocation.Left:
                        if (this.Title != "")
                        {
                            gr.DrawString(this.Title, fontb, new SolidBrush(_forecolor), new PointF(_textOffsetX + imagewidth + 4, this.Font.Size / 2 + _textOffsetY));
                            gr.DrawString(s1, this.Font, new SolidBrush(_forecolor), new PointF(_textOffsetX + imagewidth + 4, 2 * this.Font.Size + 1 + _textOffsetY));
                            gr.DrawString(s2, this.Font, new SolidBrush(_forecolor), new PointF(_textOffsetX + imagewidth + 4, 3 * this.Font.Size + 4 + _textOffsetY));
                        }
                        else
                        {
                            gr.DrawString(s1, this.Font, new SolidBrush(_forecolor), new PointF(_textOffsetX + imagewidth + 4, this.Height / 2 - this.Font.Size  + _textOffsetY));
                        }

                        break;
                    case e_imagelocation.Right:
                        gr.DrawString(this.Title, fontb, new SolidBrush(_forecolor), new PointF(_textOffsetX, this.Height / 2 - this.Font.Size + 1 - extraoffset + _textOffsetY));
                        gr.DrawString(this.Text, this.Font, new SolidBrush(_forecolor), new PointF(_textOffsetX, extraoffset + this.Height / 2 - this.Font.Size + _textOffsetY));
                        break;
                    case e_imagelocation.Top:
                        gr.DrawString(this.Text, this.Font, new SolidBrush(_forecolor), new PointF(_textOffsetX + this.Width / 2 - textwidth / 2 - 1, offsety + imageheight + _textOffsetY));
                        break;
                    case e_imagelocation.Bottom:
                        gr.DrawString(this.Text, this.Font, new SolidBrush(_forecolor), new PointF(_textOffsetX + this.Width / 2 - textwidth / 2 - 1, this.Height - imageheight - textheight + _textOffsetY));
                        break;
                    case e_imagelocation.None:
                        _forecolor = this.ForeColor;
                        gr.DrawString(this.Text, this.Font, new SolidBrush(_forecolor), new PointF(_textOffsetX + this.Width/2 - textwidth/2 - 1, this.Height/2 - textheight/2 + _textOffsetY));
                        break;
                    default:
                        break;
                }
