...
{
    public class ActionCalculate : ActionBase, IAction
    {
        public ActionCalculateData actionCalculateData;
        ...
        public String GetValue(String str)
        {
            ...
            ActionBase action = list[Convert.ToInt32(items[0]) - 1];
            Type T = action.GetType();
            object result = null;
            try
            {
                result = T.GetProperty(items[2]).GetValue(action, null);
        ...
        public ActionCalculate(ActionCalculateData actionCalculateData)
        {
            actionData = actionCalculateData;
            actionData.Name = actionCalculateData.Name;
            actionRes = ActionResponse.NonExecution;
            formAction = (FormActionCalculate)(new FormActionCalculate(actionCalculateData, this));
            this.actionCalculateData = actionCalculateData;
            Init();
        }
